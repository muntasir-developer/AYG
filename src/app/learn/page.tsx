  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 font-sans relative overflow-hidden">
      ...
      >
        ...
        >
          Choose your starting point and we'll tailor the perfect learning
          journey for you
        </motion.p>
        ...
        >
          ...
          >
            ...
            <div className="relative flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-3">
              <div className="flex items-center gap-2">
                <Rocket className="w-4 h-4 sm:w-5 sm:h-5" strokeWidth={2} />
                <span className="font-bold">Upgrade yourself</span>
              </div>
              <span className="hidden sm:block text-blue-100/80 text-xs">
                •
              </span>
              <span className="text-blue-100/90 text-xs font-normal">
          ...
          <button
            ...
            className="group relative w-full py-3.5 sm:py-4 px-5 sm:px-6 backdrop-blur-sm
                       text-white font-semibold text-sm sm:text-base rounded-xl sm:rounded-xl shadow-lg 
                       border-2 bg-orange-600 border-blue-400/30 hover:border-orange-400/50 hover:bg-orange-700
          ...
          >
            <div className="relative flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold">Learn from scratch</span>
              </div>
              <span className="hidden sm:block text-blue-100/60 text-xs">
                •
              </span>
              <span className="text-blue-100/70 text-xs font-normal">
      ...
      >
        No wrong answers — just the right path for you ✨
      </motion.p>
    </section>
  );
};
