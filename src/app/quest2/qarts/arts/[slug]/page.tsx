          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {syllabusItems.map((subject, index) => (
                  <div
                    key={index}
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
          ...
          <ul className="space-y-2 text-gray-300 text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>
                Fees may vary by institution. Always check with specific
                colleges for exact amounts.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
              <span>
                Career opportunities depend on skills, networking, and further
                specializations.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
              <span>
                Many careers require additional qualifications (MA, professional
                courses, etc.).
              </span>
            </li>
          </ul>
